...
fv = stlread('ChessKnight.stl');

fv.vertices(:,1)= fv.vertices(:,1)-mean(fv.vertices(fv.vertices(:,3)<1,1));
fv.vertices(:,2)= fv.vertices(:,2)-mean(fv.vertices(fv.vertices(:,3)<1,2));
%% Render
